...
import service.Implements.CatalogosService.CrearInstructorService;
...
public class ServletCrearInstructor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            ICrearInstructorService crearInstructor = new CrearInstructorService();
            
            crearInstructor.nuevoInstructor(instructor);
