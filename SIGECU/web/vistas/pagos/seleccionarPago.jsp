...
<head>
    ...
    <title>SIGECU-REALIZAR PAGO</title>
    <!-- Favicon-->
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class="active">
                                <a href="../../pages/examples/registro.html">Blank Page</a>
                            </li>
                            <li>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control show-tick">
                                        <option data-toggle value="">Forma de Pago</option>
                                        <option value="${pago.tipo}" >Tarjeta de Credito                        
                                        </option>
                                        <option value="${pago.tipo}">Cheque</option>
                                        <option value="${pago.tipo}">Pago en Efectivo</option>
                                    </select>
                                </div>  
                                </div>
                                </div>
