                                ...
                                <div class="body">
                                    <form id="form_advanced_validation" action="Eventos" method="POST">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line ">
                                                    <select class=" form-control show-tick" name="nombreEvento"  required>
                                                        ...
                                                        <c:forEach var="ins" items="${datosParaEvento.get(5)}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-line">Fecha de Expiración<br>
                                                    <input type="date" name="fechaTermino" class="form-control"required/>
                                                    <div class="help-info">Fecha de Inicio en el formato de AAAA-MM-DD</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <label class="">Destinatarios</label>
                                                    <select name="destinatarios" class="form-control show-tick" required >
                                                        <c:forEach var="ins" items="${datosParaEvento.get(8)}">
                                                            <option value="${ins.id}">${ins.nombre}</option>
                                                        </c:forEach>
                                                    </select>                
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-float">
                                                <div class="form-line ">
                                                    <select class=" form-control show-tick" name="lugarEvento"  required>
                                                        <option value="">Ninguno</option>
                                                        <c:forEach var="ins" items="${datosParaEvento.get(6)}">
                                                            <option  value="${ins.id}">${ins.nombre}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                             <div class="form-group form-float">
                                                <div class="form-line ">
                                                    <select class=" form-control show-tick" name="costoEvento"  required>
                                                        <option value="">Ninguno</option>
                                                        <c:forEach var="ins" items="${datosParaEvento.get(7)}">
                                                            <option  value="${ins.id}">${ins.nombre}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
